    ...
    function(a, b, c) {
      ...
      function d(a, b) {
        ...
        var c,
          ...
          l = d.path,
          m = j[k] && l in j[k].nsps,
          n = b.forceNew || b['force new connection'] || !1 === b.multiplex || m
        return (
          n
        ...
        ;(a.exports = e),
          ...
          b.document &&
            (b.attachEvent
              ...
              : b.addEventListener && b.addEventListener('beforeunload', g, !1))
      }.call(
        b,
        (function() {
          return this
                ...
                g.encodePacket(a, d.supportsBinary, function(f) {
                  if (!d.usingBrowserWebSocket) {
                    ...
                    if (
                      ...
                      var h =
                        'string' == typeof f ? b.Buffer.byteLength(f) : f.length
